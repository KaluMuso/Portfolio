...
const socialLinks = [
  {
    name: "GitHub",
    href: "https://github.com/KaluMuso",
    icon: GitHubIcon,
  },
  {
    name: "LinkedIn",
    href: "https://linkedin.com/in/kaluba",
    icon: LinkedInIcon,
  },
]
    ...
    <footer className="mt-auto border-t bg-background/80 backdrop-blur-sm">
      <Container className="py-8 flex flex-col sm:flex-row items-center justify-between gap-4">
        <div className="flex flex-col items-center sm:items-start gap-1">
          <Link
            href="/"
            className="font-heading text-base font-bold tracking-tight text-primary italic"
          >
            Kaluba
          </Link>
          <p className="text-xs text-muted-foreground">
            © {new Date().getFullYear()} Kaluba Musonda. All rights reserved.
          </p>
        </div>

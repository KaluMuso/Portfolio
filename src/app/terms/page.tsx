  ...
  return (
    <div className="py-24 px-6 md:px-12 max-w-4xl mx-auto min-h-screen">
      ...
      <div className="prose prose-blue text-gray-600 space-y-6">
        ...
        <p>
          Welcome to Vergeo Group. By using our website and services, you
        ...
        <h2 className="text-2xl font-bold text-gray-900 dark:text-white">Waitlist</h2>
        <p>
        ...
        <p>
          Vergeo Group shall not be liable for any indirect, incidental, or

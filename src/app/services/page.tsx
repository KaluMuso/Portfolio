...
const services = [
  ...
  },
  {
    ...
    tagline: "Consultation, workshops & training",
    description: "One-on-one consultation, team workshops, and hands-on training — plus custom AI agents, chatbots, and LLM workflows scoped and integrated into your stack.",
    features: ["Strategy consults", "Team workshops", "Custom AI agents", "LLM integrations & RAG"],
    from: 200,
    color: "indigo",
  },
  {
    ...
    features: ["Product management", "Lenco and DPO payments", "Inventory sync", "Mobile checkout"],
    from: 350,
    color: "teal",
  },
];
